...
ThriftAggregatePluginRequest = function (args) {
    ...
    if (args != null) {
        if (null != args.pluginRequestArray)
...
ThriftCrossDomainPolicyResponse = function (args) {
    ...
    this.port = null
    if (args != null) {
        if (null != args.customFileEnabled)
...
ThriftGenericErrorResponse = function (args) {
    ...
    if (args != null) {
        if (null != args.requestMessageType)
...
ThriftGetServerLocalTimeResponse = function (args) {
    ...
    if (args != null) {
        if (null != args.serverLocalTimeInMilliseconds)
...
ThriftPingRequest = function (args) {
    ...
    if (args != null) {
        if (null != args.globalResponseRequested)
...
ThriftProtocolConfiguration = function (args) {
    ...
    if (args != null) {
        if (null != args.messageCompressionThreshold)
